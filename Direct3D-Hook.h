#pragma once
	...
	#define D3DHOOK_API2(hr) extern "C" __declspec(dllexport) hr __stdcall
#else
	#define D3DHOOK_API __declspec(dllimport)
#endif

void __declspec(dllexport) __stdcall InstallHook();
void __declspec(dllexport) __stdcall RemoveHook();
void __declspec(dllexport) __stdcall SetTarget();
...
typedef struct SusiePictureInfo
{
